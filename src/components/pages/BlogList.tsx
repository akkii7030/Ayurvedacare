    ...
    <PageShell>
      <section className="bg-hero-gradient text-primary-foreground py-14">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="opacity-90 mt-2">Eye care, Ayurveda, women&apos;s health, emergency awareness.</p>
          <HeroMedia
            src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=1400&auto=format&fit=crop"
            alt="Doctor writing health advice and monitoring patient records"
            badge="Trusted health education"
          />
        </div>
      </section>
      <section className="py-12 container mx-auto px-4 grid md:grid-cols-3 gap-5">
        {blogs.map((b) => (
          <article key={b._id} className="bg-card rounded-xl p-5 shadow-card">
            ...
            <Link className="inline-block text-primary text-sm mt-4" href={`/blog/${b.slug}`}>
              Read article
            </Link>
          </article>
        ))}
