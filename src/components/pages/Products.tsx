    ...
    <PageShell>
      <section className="bg-hero-gradient text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <HeroMedia
            src="https://images.pexels.com/photos/6978215/pexels-photo-6978215.jpeg?cs=srgb&dl=pexels-heather-brock-31614773-6978215.jpg&fm=jpg"
            alt="Ayurvedic herbs and wellness supplies"
          />
        </div>
      </section>
