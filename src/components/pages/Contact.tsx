    ...
    <PageShell>
      <section className="bg-hero-gradient text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-heading font-bold text-4xl md:text-5xl mb-3">{t("contact.title")}</h1>
          <p className="opacity-90">{t("contact.subtitle")}</p>
          <HeroMedia
            src="/contact-support.png"
            alt="Friendly hospital staff guiding a patient at reception"
            badge={t("contact.getInTouch")}
          />
          <a
            href="https://wa.me/916386192882"
            className="inline-flex items-center justify-center mt-6 bg-success text-success-foreground px-5 py-2.5 rounded-lg text-sm font-semibold"
          >
            WhatsApp Us
          </a>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  { icon: Phone, label: "Phone", value: "+91-6386192882" },
                  { icon: Phone, label: "Emergency", value: "+91-6386192882 (24x7)" },
                  { icon: MessageCircle, label: "WhatsApp", value: "+91-6386192882" },
          ...
          <div className="mt-12 rounded-xl overflow-hidden shadow-card">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114867.7656920958!2d82.60!3d25.75!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399037c688318d17%3A0xe54c1f3014a9051c!2sJaunpur%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
