    ...
    <section className="py-16 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {products.map((p) => (
            <article key={p.name} className="bg-card rounded-xl p-5 shadow-card hover:shadow-card-hover transition-all hover:-translate-y-1 border border-border/60">
        ...
        <div className="text-center mt-8">
          <Link href="/products" className="inline-block bg-hero-gradient text-primary-foreground px-6 py-2.5 rounded-lg">
